        ...
        if(yturl === true){
          ...
          try{
            ...
            var ytdlPlaylistInfo = ytdlPlaylist.entries.map(v => {
              return {url: v.url, quality: settings['quality'], audiotype: settings['audiotype'], info: v, volume: settings['volume']};
            });
            console.log("YTDL Playlist", ytdlPlaylist, ytdlPlaylistInfo, "\nOOF!")
